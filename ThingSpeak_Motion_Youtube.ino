...
char ssid[] = "midhun";                               // Enter your WiFi SSID (router name)
char pass[] = "hari1234";                             // Enter your WiFi router password
unsigned long myChannelNumber = 894260;                 // Enter your Thingspeak Channel Number
const char * myWriteAPIKey = "BNKQXFZPBPFRSOBI";        // Enter your ThingSpeak API Key
